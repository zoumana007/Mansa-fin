...
Apparition, compteur, pulsation unique et disparition.
...
Mouvement discret, possibilité d’interrompre et durée liée au traitement réel.
...
Rotation lente, pays actifs, points, trajectoires, zoom, sélection et statistiques. Fallback obligatoire en 2D ou liste.

## 114. Site web — particules

Faible densité, vitesse lente, arrêt hors écran, qualité adaptable et aucune obstruction du texte.
...
Niveaux : fond, contenu, objet, lumière et particules.

## 118. Site web — scroll reveal

Fondu, montée, déplacement horizontal, échelle, masque et dessin.

## 119. Site web — storytelling

Introduction, problème, solution, produit, preuve, impact et appel à l’action.
...
Contrôle manuel, pause, navigation clavier, indicateurs, gestes tactiles et vitesse modérée.
...
Le mouvement doit privilégier preuve, statut, traçabilité, confirmation, contrôle et sécurité.
...
Démonstration, recette et production doivent avoir transition visible, bannière, couleur, confirmation et rappel permanent.
...
Animations minimales : comparaison, changement, détail, filtre et export.
...
Chaque animation doit respecter la réduction des mouvements, rester compréhensible sans animation, éviter le clignotement, fonctionner au clavier et préserver le focus.

## 140. Réduction des mouvements

Supprimer rotations, parallaxe, mouvements 3D, déplacements importants et particules. Remplacer par des fondus tout en conservant les confirmations.

## 141. Mode économie d’énergie

Réduire particules, flous, ombres animées et fréquences. Suspendre hors écran et désactiver la 3D lourde.

## 142. Performance web

Privilégier `transform` et `opacity`, suspendre hors écran, charger la 3D à la demande, compresser les modèles, limiter les filtres et fournir des fallbacks.

## 143. Performance mobile

Utiliser le thread natif, éviter les calculs JavaScript continus, limiter les flous et animations simultanées et tester sur Android d’entrée de gamme.
...
Framer Motion, GSAP, React Three Fiber, Three.js, Rive, Lottie, CSS animations et Web Animations API.

## 146. Technologies React Native

React Native Reanimated, Moti, Gesture Handler, Lottie, Rive et Haptics natifs.

## 147. Technologies Android TPE

Jetpack Compose, MotionLayout, animations Android natives, haptique natif et sons locaux.
...
Format : `Mansa/Motion/Produit/Composant/Action/État`.

Exemple : `Mansa/Motion/Mobile/Payment/Confirm/Success`.
...
Tester sur petit Android, grand Android, iPhone, tablette, TPE, navigateur mobile, ordinateur portable, grand écran, connexion faible, appareil faible, modes clair et sombre, réduction des mouvements et économie d’énergie.

## 152. Critères de validation

Une animation est validée si elle améliore la compréhension, reste fluide, ne bloque rien, fonctionne sans son ni vibration, respecte la réduction des mouvements, ne masque aucune erreur et ne retarde pas l’action réelle.

## 153. Gouvernance

Toute nouvelle animation doit répondre à un besoin, utiliser les tokens, éviter les doublons, être documentée, testée, accessible, validée, versionnée et prévoir un fallback.
